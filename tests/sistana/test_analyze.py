...
from firework.framework.command.core.model.receiver import CountRx, Rx
...
def test_analyze_slots():
    ...
    a.expect(LoopflowRejectReason.unsatisfied)
    bf.expect_empty()
...
def test_analyze_option_duplicated():
    ...
    a.expect(LoopflowRejectReason.option_duplicated_prohibited)
    bf.expect_empty()
...
def test_prefix():
    ...
    a.expect(LoopflowRejectReason.prefix_mismatch)
    bf.expect_empty()
    ...
    a.expect(LoopflowRejectReason.prefix_expect_str)
...
def test_header():
    ...
    a.expect(LoopflowRejectReason.header_mismatch)

    a, sn, bf = analyze(
        pattern,
        Buffer([1]),
    )
    a.expect(LoopflowRejectReason.header_expect_str)
...
def test_subcommand():
    ...
    # a.expect(LoopflowRejectReason.unsatisfied_switch_subcommand)
    a.expect(LoopflowRejectReason.previous_subcommand_unsatisfied)
...
def test_switch_from_option():
    ...
    a.expect(LoopflowRejectReason.previous_option_unsatisfied)
