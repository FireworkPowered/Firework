...
if TYPE_CHECKING:
    from .endpoint import CollectEndpointTarget, Fn


class FnImplementEntity(Generic[CR], BaseEntity):
    targets: list[tuple[Fn, CollectEndpointTarget]]
    impl: CR
    ...
    def add_target(self, endpoint: Fn[P, Any], generator: CollectEndpointTarget):
